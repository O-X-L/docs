...
html_theme_options = {
    'banner_text': '<a href="https://www.o-x-l.com">About OXL</a> | '
                   ...
                   '<a href="https://docs.o-x-l.at" title="Zur deutschsprachigen Version wechseln"><img loading="lazy" style="height: 12px; padding: 0; border-radius: 0;" src="https://files.oxl.at/img/flag_de.svg" alt="German Flag"> Deutsch</a>'
}
