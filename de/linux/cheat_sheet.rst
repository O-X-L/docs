...
Selbst-Signiertes Zertifikat erstellen (EC):
...
Um eine interne PKI/CA zu erstellen, würden wir empfehlen das Projekt `EasyRSA <https://easy-rsa.readthedocs.io/en/latest/>`_ anzusehen.
